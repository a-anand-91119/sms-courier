...
class HomeViewModelTest {
    ...
    private val approvedDevicesFlow = MutableStateFlow(emptyList<dev.notyouraverage.smscourier.data.entities.PairedDevice>())
    private val pendingRequestsFlow = MutableStateFlow(emptyList<dev.notyouraverage.smscourier.data.entities.PairedDevice>())
    private val activeSessionsFlow = MutableStateFlow(emptyList<dev.notyouraverage.smscourier.data.entities.ForwardingSession>())
