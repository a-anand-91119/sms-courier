package dev.notyouraverage.otpcourier.notifications
...
import dev.notyouraverage.otpcourier.receivers.PairingActionReceiver
...
class PairingNotificationManager(private val context: Context) {
    ...
    companion object {
        ...
        const val ACTION_APPROVE = "dev.notyouraverage.otpcourier.ACTION_APPROVE_PAIRING"
        const val ACTION_REJECT = "dev.notyouraverage.otpcourier.ACTION_REJECT_PAIRING"
