package dev.notyouraverage.otpcourier.services
...
class SmsSender(private val context: Context) {
    ...
    companion object {
        ...
        const val SMS_SENT_ACTION = "dev.notyouraverage.otpcourier.SMS_SENT"
    ...
    fun sendForwardedSms(sourcePhoneNumber: String, originalSender: String, message: String, encryptionKey: String? = null) {
        val forwardMessage = if (encryptionKey != null) {
            ...
            val encrypted = dev.notyouraverage.otpcourier.security.MessageEncryption.encrypt(plainContent, encryptionKey)
            if (encrypted != null) {
